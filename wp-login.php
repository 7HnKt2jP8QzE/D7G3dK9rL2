...
<link rel="stylesheet" id="dashicons-css" href="./wp-includes/css/dashicons.min.css?ver=6.2.1" media="all">
<link rel="stylesheet" id="buttons-css" href="./wp-includes/css/buttons.min.css?ver=6.2.1" media="all">
<link rel="stylesheet" id="forms-css" href="./wp-admin/css/forms.min.css?ver=6.2.1" media="all">
<link rel="stylesheet" id="l10n-css" href="./wp-admin/css/l10n.min.css?ver=6.2.1" media="all">
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.2.1" media="all">
		...
		<form name="loginform" id="loginform" action="./wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acceder">
					...
					<p id="nav">
				<a href="./wp-login.php?action=lostpassword">¿Has olvidado tu contraseña?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./">&larr; Ir a David Benavides</a>		</p>
			</div>
...
<script src="./wp-admin/js/password-strength-meter.min.js?ver=6.2.1" id="password-strength-meter-js"></script>
<script src="./wp-includes/js/underscore.min.js?ver=1.13.4" id="underscore-js"></script>
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/wordpress\/wp-admin\/admin-ajax.php"}};</script>
<script src="./wp-includes/js/wp-util.min.js?ver=6.2.1" id="wp-util-js"></script>
...
<script src="./wp-admin/js/user-profile.min.js?ver=6.2.1" id="user-profile-js"></script>
	<div class="clear"></div>
	</body>
	</html>